...
/* PWM Driving signals initialization ----------------------------------------*/
  ...
  .ADCConfig = { ( uint32_t )( 11<<ADC_JSQR_JSQ3_Pos ) | 10<<ADC_JSQR_JSQ4_Pos | 1<<ADC_JSQR_JL_Pos,
                ( uint32_t )( 0<<ADC_JSQR_JSQ3_Pos ) | 10<<ADC_JSQR_JSQ4_Pos | 1<<ADC_JSQR_JL_Pos,
                ( uint32_t )( 0<<ADC_JSQR_JSQ3_Pos ) | 10<<ADC_JSQR_JSQ4_Pos | 1<<ADC_JSQR_JL_Pos,
                ( uint32_t )( 0<<ADC_JSQR_JSQ3_Pos ) | 11<<ADC_JSQR_JSQ4_Pos | 1<<ADC_JSQR_JL_Pos,
                ( uint32_t )( 0<<ADC_JSQR_JSQ3_Pos ) | 11<<ADC_JSQR_JSQ4_Pos | 1<<ADC_JSQR_JL_Pos,
                ( uint32_t )( 11<<ADC_JSQR_JSQ3_Pos ) | 10<<ADC_JSQR_JSQ4_Pos | 1<<ADC_JSQR_JL_Pos,
              },
